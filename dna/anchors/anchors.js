  ...
  if (anchorGet === null) {
    ...
    if (anchorTypeGet === null) {
      ...
      debug(
        '<mermaid>' +
          App.Agent.String +
          '-->>DHT:Check to see if the Root of all anchors has been setup</mermaid>'
      );
      if (rootAnchorTypeHash === null) {
        ...
        debug(
          '<mermaid>' +
            ...
            '->>' +
            App.Agent.String +
            ':commit Root of all anchors to local chain</mermaid>'
        );
        debug(
          '<mermaid>' +
            App.Agent.String +
            '->>DHT:Publish Root of all anchors</mermaid>'
        );
      ...
      debug(
        '<mermaid>DHT-->>' +
          App.Agent.String +
          ':Return the Root Anchor Type</mermaid>'
      );
      ...
      debug(
        '<mermaid>' +
          ...
          '->>DHT:Link ' +
          anchor.anchorType +
          ' to Root of all anchors</mermaid>'
      );
    } else {
